...
public static class AssemblyManager
{
    ...
    public static void Init()
    {
        ...
        {
            throw new BusinessException("Bee.Abp:0012");
        }
    ...
    {
        var assemblyLocation = Path.GetDirectoryName(typeof(AssemblyManager).Assembly.Location);
        if (string.IsNullOrEmpty(assemblyLocation))
        {
            throw new BusinessException(code: "Bee.Abp:0013");
        }
