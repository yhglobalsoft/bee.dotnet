...
public static class Guard
{
    ...
    public static T NotNull<T>(T value, string valueName)
    {
        if (null == value)
        {
            throw new BeeNullException(valueName);
        }
        ...
        int minLength = 0)
    {
        ...
        {
            throw new BeeNullOrEmptyException(valueName);
        }

        if (value!.Length > maxLength)
        {
            throw new BeeLengthGreaterException(valueName, maxLength);
        }

        if (minLength > 0 && value.Length < minLength)
        {
            throw new BeeLengthLessException(valueName, minLength);
        }
        ...
        int minLength = 0)
    {
        ...
        {
            throw new BeeNullOrWhiteSpaceException(valueName);
        }
        ...
        string valueName)
    {
        if (value == Guid.Empty)
        {
            throw new BeeEmptyGuidException(valueName);
        }
        ...
        where T : IComparable<T>
    {
        ...
        if (!flag)
        {
            throw new BeeOutOfRangeException(valueName, canEqual, false,
        ...
        where T : IComparable<T>
    {
        ...
        if (!flag)
        {
            throw new BeeOutOfRangeException(valueName, false, canEqual,
                target.ToString());
        }
    }
        ...
        where T : IComparable<T>
    {
        ...
        if (!flag)
        {
            throw new BeeOutOfRangeException(valueName, startEqual, false,
                null, start.ToString());
        }
        ...
        if (!flag)
        {
            throw new BeeOutOfRangeException(valueName, false, endEqual,
                end.ToString());
        }
    }
        ...
        string parameterName)
    {
        ...
        {
            throw new BeeNullOrWhiteSpaceException(parameterName);
        }

        if (!Directory.Exists(directory))
        {
            throw new BeeDirectoryNotFoundException(directory);
        }
        ...
        string valueName)
    {
        ...
        {
            throw new BeeFileNotFoundException(filename);
        }
