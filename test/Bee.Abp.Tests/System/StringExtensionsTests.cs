...
namespace System
{
    public class StringExtensionsTests
    {
        ...
        [Fact]
        public void ToNameDesensitizationTest()
        {
            const string name1 = "王五";
            const string name2 = "王老五";
            const string name3 = "张王老五";
            var name4 = string.Empty;
            Assert.Equal("王*", name1.ToNameDesensitization());
            Assert.Equal("王*五", name2.ToNameDesensitization());
            Assert.Equal("张**五", name3.ToNameDesensitization());
            Assert.Null(name4.ToNameDesensitization());
        }
        
        [Fact]
        public void ToPhoneNumberDesensitizationTest()
        {
            const string phone1 = "12345678901";
            const string phone2 = "400";
            const string phone3 = "1234";
            const string phone4 = "123456";
            var phone5 = string.Empty;
            Assert.Equal("123****8901", phone1.ToPhoneNumberDesensitization());
            Assert.Equal("400", phone2.ToPhoneNumberDesensitization());
            Assert.Equal("123*", phone3.ToPhoneNumberDesensitization());
            Assert.Equal("123***", phone4.ToPhoneNumberDesensitization());
            Assert.Null(phone5.ToPhoneNumberDesensitization());
        }
    }
}